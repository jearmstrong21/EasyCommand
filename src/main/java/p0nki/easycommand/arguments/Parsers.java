...
public class Parsers {
    ...
    public static final ParserFactory STRING = ParserFactory.name("STRING", argument -> {
        ...
        if (argument.getModifiers().contains(GREEDY_STRING)) return Optional.of(reader -> {
    ...
    public static final ParserFactory BYTE = ParserFactory.name("BYTE", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Byte.parseByte(reader.readWord())));
    });
    ...
    public static final ParserFactory SHORT = ParserFactory.name("SHORT", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Short.parseShort(reader.readWord())));
    });
    public static final ParserFactory INT = ParserFactory.name("INT", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Integer.parseInt(reader.readWord())));
    });
    public static final ParserFactory LONG = ParserFactory.name("LONG", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Long.parseLong(reader.readWord())));
    });
    public static final ParserFactory FLOAT = ParserFactory.name("FLOAT", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Float.parseFloat(reader.readWord())));
    });
    public static final ParserFactory DOUBLE = ParserFactory.name("DOUBLE", argument -> {
        ...
        return Optional.of(reader -> Optional.emptyIfThrow(() -> Double.parseDouble(reader.readWord())));
    });
